...
class DatabaseHelper {
  ...
  static const databaseName = 'al3.db'; //
  ...
  initializeDatabase() async {
    return await openDatabase(join(await getDatabasesPath(), databaseName),
      ...
      await db.execute( //
          "CREATE TABLE todos(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nombre TEXT, carrera TEXT, email TEXT, celular TEXT, domicilio TEXT, ciudad TEXT)");
    });
  }
